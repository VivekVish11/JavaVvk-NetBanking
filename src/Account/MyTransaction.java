...
public class MyTransaction extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jDateChooser3.setFont(new java.awt.Font("sansserif", 0, 18)); // NOI18N
...
//        System.out.println("Admin Page" + this.a);
//        System.out.println("User Page" + this.b);
        if(a==1){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MyTransaction.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
